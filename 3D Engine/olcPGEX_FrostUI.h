...
namespace olc
{
    ...
    public:
        //Added by Hatz
        static inline std::string sCopiedText;
...
namespace olc
{
    ...
    */
    ...
    void FUI_Element::set_item(const std::string& item)
    {
    ...
    */
    ...
    void FUI_Inputfield::input(olc::PixelGameEngine* pge)
    {
        ...
        if (is_focused)
        {
            ...
            {
                FUI_Window::sCopiedText = "";

                FUI_Window::sCopiedText = displayed_text;
            ...
            /*std::cout << std::endl;
            std::cout<< "copied text: " << FUI_Window::sCopiedText << std::endl;
            std::cout << "displayed_text: " << displayed_text << std::endl;
            std::cout << "inputfield_text: " << inputfield_text << std::endl;
            std::cout << "text_out_of_view: " << text_out_of_view << std::endl;*/

            //Added by Hatz
            if (select_all && pge->GetKey(olc::CTRL).bHeld && pge->GetKey(olc::V).bPressed)
            {
                ...
                displayed_text = FUI_Window::sCopiedText;
                displayed_text.pop_back();

                inputfield_text = FUI_Window::sCopiedText;
            ...
            //Added by Hatz
            /*if (pge->GetKey(olc::CTRL).bHeld && pge->GetKey(olc::Z).bPressed)
            {
                inputfield_text = old_inputfield_text;
                displayed_text = old_inputfield_text;
            }*/
